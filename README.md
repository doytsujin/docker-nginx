...
### Prebuilt Images
Builds of the image are available on [Docker Hub](https://hub.docker.com/ryanwclark/nginx) and is the recommended method of installation.
...
```bash
docker pull ryanwclark/nginx:(imagetag)
```
#### Multi Archictecture
...
| [OS Base](https://github.com/ryanwclark/docker-debian/) | Customized Image based on Debian Linux |
